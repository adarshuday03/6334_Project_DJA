...
Parts 1 & 2: Conceptual Analysis and Optimal Order Quantity

SparkFire Newsvendor Model
"""
...
def expected_sales(Q, a, b):
    ...
    if Q <= a:
        return Q  # sell everything ordered
    elif Q >= b:
        return (a + b) / 2  # expected demand
    else:
        # integral calculation for uniform
        part1 = (Q**2 - a**2) / (2 * (b - a))  # when demand < Q
        part2 = Q * (b - Q) / (b - a)           # when demand >= Q
        return part1 + part2
